...
**1. Choose an rTASSEL Git tag** (for example `v0.12.0`) for both the build
context and `RTASSEL_TAG`. The URL fragment `#v0.12.0` tells Docker to fetch
...
examples below assume `rtassel:v0.12.0`. If you already have a clone of the
